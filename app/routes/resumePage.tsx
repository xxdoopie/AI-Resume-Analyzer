...
export function meta() {
    return [
        ...
        { name: "description", content: "<Dialog></Dialog>etailed overview of your resume" },
    ];
}
...
const resumePage = () => {
    ...
    useEffect(() => {
        ...
        loadResume();
    }, [id]); //as soon as we get the id of the resume we want to fetch the useEffect function runs
    return (
        <main className="!pt-0">
